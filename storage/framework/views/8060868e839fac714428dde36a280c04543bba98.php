							...
							<div class="top-menu-area">
								...
								<ul class="top-menu">
									...
									<li><a href="<?php echo e(route('logout')); ?>"
					                        ...
					                        <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" ><?php echo e(csrf_field()); ?></form>
									</li>
								</ul>
							</div>
				...
				<section class="popupBody">
					...
					<div class="user_register">
                        ...
                        <?php echo e(csrf_field()); ?>
							...
							<div class="form-group">
                        		<input id="name" type="text" class="form-control col-md-9 col-md-push-1" style="border-radius: 0px;" name="name" value="<?php echo e(old('name')); ?>" required autofocus>
                        	</div>
