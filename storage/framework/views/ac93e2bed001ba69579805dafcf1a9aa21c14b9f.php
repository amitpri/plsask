							...
							<div id="w4-account" class="tab-pane active">
									...
									<div class="form-group">
										...
										<div class="col-md-4 form-inline">
											...
											<input type="text" id="room_nos" class="form-control"  value="<?php echo e($hotelrooms->room_nos); ?>">
										...
										<div class="col-md-4  form-inline">
											...
											<input type="text" id="floor" class="form-control" 
												value="<?php echo e($hotelrooms->floor); ?>">
									...
									<div class="form-group">
										...
										<div class="col-md-4 form-inline">
											...
											<input type="text" name="adults" class="form-control" value="<?php echo e($hotelrooms->adults); ?>" >
										...
										<div class="col-md-4  form-inline">
											...
											<input type="text" name="kids" class="form-control" value="<?php echo e($hotelrooms->kids); ?>">
											<p v-if="error_newtopic" class="text-danger">{{ message_newtopic }}</p>
									...
									<div class="form-group">
										...
										<div class="col-md-7">
											...
											<input type="text" name="roomtype" class="form-control" value="<?php echo e($hotelrooms->name); ?>" >
											<p v-if="error_newtopic" class="text-danger">{{ message_newtopic }}</p>
									...
									<div class="form-group">
										...
										<div class="col-md-7">
											...
											<input type="text" name="bedtype" class="form-control" value="<?php echo e($hotelrooms->beds); ?>" >
											<p v-if="error_newtopic" class="text-danger">{{ message_newtopic }}</p>
...
<script>
	...
	new Vue({
		...
		data: {
			...
			showTopic : false,
			inpTopic : "",
			inpRoomnos: "<?php echo $hotelrooms->room_nos; ?>",
			inpFloor: "",
			inpAdults: "",
			inpKids: "",
			inpRoomtype : "",
