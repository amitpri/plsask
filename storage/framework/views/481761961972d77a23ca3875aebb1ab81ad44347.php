						...
						<fieldset>
							<div class="form-group">
								...
								<div class="col-md-8">
									...
									<?php echo Form::text('whatsapp',null,	['class' => 'form-control','v-on:change' => 'methodWhatsapp','v-model' => 'inpWhatsapp']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									...
									<?php echo Form::text('facebook',null,	['class' => 'form-control','v-on:change' => 'methodFacebook','v-model' => 'inpFacebook']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									...
									<?php echo Form::text('twitter',null,	['class' => 'form-control','v-on:change' => 'methodTwitter','v-model' => 'inpTwitter']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									...
									<?php echo Form::text('linkedin',null,	['class' => 'form-control','v-on:change' => 'methodLinkedin','v-model' => 'inpLinkedin']); ?>
						...
						<fieldset>
							<div class="form-group">
								...
								<div class="col-md-8">
									...
									<?php echo Form::text('company',null,	['class' => 'form-control','v-on:change' => 'methodCompany','v-model' => 'inpCompany']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									...
									<?php echo Form::text('company_role',null,	['class' => 'form-control','v-on:change' => 'methodRole','v-model' => 'inpRole']); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									...
									<?php echo Form::text('company_designation',null,	['class' => 'form-control','v-on:change' => 'methodDesignation','v-model' => 'inpDesignation']); ?>
