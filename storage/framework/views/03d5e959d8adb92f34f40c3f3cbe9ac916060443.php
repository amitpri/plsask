					...
					<div class="panel-body"> 			 
						...
						<div class="form-group">
							...
							<div class="col-md-12 center">
								...
								<form style="margin-top: 15px;padding: 10px;" action="<?php echo e(URL::to('/profiles/upload/uploadexcel')); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
