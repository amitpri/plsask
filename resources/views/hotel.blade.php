						...
						<fieldset> 
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!!  Form::text('name',null,['class' => 'form-control', 'style' => 'border-radius: 0;height:26px; font-size:12px; ','v-on:change' => 'methodName','v-model' => 'inpName']) !!}
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!!  Form::text('email1',null,	['class' => 'form-control', 'style' => 'border-radius: 0;height:26px;font-size:12px; ','v-on:change' => 'methodEmail1','v-model' => 'inpEmail1']) !!}
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!!  Form::text('email2',null,	['class' => 'form-control','style' => 'border-radius: 0;height:26px;font-size:12px; ','v-on:change' => 'methodEmail2','v-model' => 'inpEmail2']) !!}
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!!  Form::text('email3',null,	['class' => 'form-control','style' => 'border-radius: 0;height:26px;font-size:12px; ','v-on:change' => 'methodEmail3','v-model' => 'inpEmail3']) !!}
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!!  Form::text('phone1',null,	['class' => 'form-control','style' => 'border-radius: 0;height:26px;font-size:12px; ','v-on:change' => 'methodPhone1','v-model' => 'inpPhone1']) !!}
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!!  Form::text('phone2',null,	['class' => 'form-control','style' => 'border-radius: 0;height:26px;font-size:12px; ','v-on:change' => 'methodPhone2','v-model' => 'inpPhone2']) !!}
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!!  Form::text('phone3',null,	['class' => 'form-control','style' => 'border-radius: 0;height:26px;font-size:12px; ','v-on:change' => 'methodPhone3','v-model' => 'inpPhone3']) !!}
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!!  Form::text('city',null,	['class' => 'form-control','style' => 'border-radius: 0;height:26px;font-size:12px; ','v-on:change' => 'methodCity','v-model' => 'inpCity']) !!}
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!! Form::textarea('address', null, ['class' => 'form-control', 'style' => 'border-radius: 0;height:60px;font-size:12px; ',
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!! Form::textarea('details', null, ['class' => 'form-control', 'style' => 'border-radius: 0;height:100px;font-size:12px; ',
						...
						<fieldset> 
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!!  Form::text('rules1',null,['class' => 'form-control', 'style' => 'border-radius: 0;height:26px; font-size:12px; ','v-on:change' => 'methodRules1','v-model' => 'inpRules1']) !!}
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!!  Form::text('rules2',null,['class' => 'form-control', 'style' => 'border-radius: 0;height:26px; font-size:12px; ','v-on:change' => 'methodRules2','v-model' => 'inpRules2']) !!}
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!!  Form::text('rules3',null,['class' => 'form-control', 'style' => 'border-radius: 0;height:26px; font-size:12px; ','v-on:change' => 'methodRules3','v-model' => 'inpRules3']) !!}
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!!  Form::text('rules4',null,['class' => 'form-control', 'style' => 'border-radius: 0;height:26px; font-size:12px; ','v-on:change' => 'methodRules4','v-model' => 'inpRules4']) !!}
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!!  Form::text('rules5',null,['class' => 'form-control', 'style' => 'border-radius: 0;height:26px; font-size:12px; ','v-on:change' => 'methodRules5','v-model' => 'inpRules5']) !!}
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!!  Form::text('rules6',null,['class' => 'form-control', 'style' => 'border-radius: 0;height:26px; font-size:12px; ','v-on:change' => 'methodRules6','v-model' => 'inpRules6']) !!}
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!!  Form::text('rules7',null,['class' => 'form-control', 'style' => 'border-radius: 0;height:26px; font-size:12px; ','v-on:change' => 'methodRules7','v-model' => 'inpRules7']) !!}
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!!  Form::text('rules8',null,['class' => 'form-control', 'style' => 'border-radius: 0;height:26px; font-size:12px; ','v-on:change' => 'methodRules8','v-model' => 'inpRules8']) !!}
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!!  Form::text('rules9',null,['class' => 'form-control', 'style' => 'border-radius: 0;height:26px; font-size:12px; ','v-on:change' => 'methodRules9','v-model' => 'inpRules9']) !!}
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									{!!  Form::text('rules10',null,['class' => 'form-control', 'style' => 'border-radius: 0;height:26px; font-size:12px; ','v-on:change' => 'methodRules10','v-model' => 'inpRules10']) !!}
...
<script>
	...
	Vueprofile = new Vue({
		...
		data: {
			...
			inpRules1 : "{!! $hotel->rules1 !!}",
			inpRules2 : "{!! $hotel->rules2 !!}",
			inpRules3 : "{!! $hotel->rules3 !!}",
			inpRules4 : "{!! $hotel->rules4 !!}",
			inpRules5 : "{!! $hotel->rules5 !!}",
			inpRules6 : "{!! $hotel->rules6 !!}",
			inpRules7 : "{!! $hotel->rules7 !!}",
			inpRules8 : "{!! $hotel->rules8 !!}",
			inpRules9 : "{!! $hotel->rules9 !!}",
			inpRules10 : "{!! $hotel->rules10 !!}",
